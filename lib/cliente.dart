import 'package:designer_patters_prototype/i_prototype.dart';
import 'package:designer_patters_prototype/telefone.dart';
...
class Cliente implements IPrototype<Cliente> {
  ...
  factory Cliente() {
    ...
    c._cpf = '231321322';
    c.telefones = [
      Telefone(telefone: '(12)21133232'),
      Telefone(telefone: '(11)323232'),
    ];
    return c;
  }
